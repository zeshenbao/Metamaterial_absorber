...
def meas_setup():
    ...
    #znb.write_str_with_opc("INIT1:CONT OFF")
    #sleep(8)  # It will take some time to perform a complete sweep - wait for it
...
points = 99999  # Number of sweep points
