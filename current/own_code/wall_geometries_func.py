...
def make_pyramid(base=(1.0, 1.0), height=1.0, foundation=3.0):
...
def make_block(base=(1.0, 1.0), height=2.0, foundation=3.0):
...
def add_foundation(geometry, thickness=3.0):
...
exportes.export(pyramid, "pyramid_func.stl")
